...
public class AdministrationResource {
	...
	@GetMapping("/{id}")
	public ResponseEntity<AdministrationResponse> findAdministrationById(@PathVariable("id") final String id) {
		return ResponseEntity.ok().body(localsGateway.findAdministrationById(id));
	}
